...
function MainDashboard() {
    ...
    const [twentyPercentageSoilSensor1, setTwentyPercentageSoilSensor1] =
        useState(null);
    const [twentyPercentageSoilSensor2, setTwentyPercentageSoilSensor2] =
        useState(null);
                ...
                <StatsGrid
                    data={[
                        ...
                        },
                        {
                            ...
                            diff:
                                parseInt(`${dataComparator.bitSoilSensor1}`) -
                                parseInt(`${dataInterface.bitSoilSensor1}`),
                        },
                        {
                        ...
                        },
                        {
                            ...
                            diff:
                                parseInt(`${dataComparator.bitSoilSensor2}`) -
                                parseInt(`${dataInterface.bitSoilSensor2}`),
                        },
                        {
